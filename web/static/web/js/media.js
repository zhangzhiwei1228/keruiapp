// media 资源上传
define(['jquery', 'adminer/js/ui', 'template', 'tools','jquery.ui.widget', 'jquery.iframe-transport', 'jquery.fileupload-process', 'jquery.fileupload','jquery.number', 'jquery.xdr-transport'],
