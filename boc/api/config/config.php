...
/* 会话Session Variables */
$config['sess_cookie_name']        = DB_PREFIX.'session_api';
$config['sess_expiration']        = 7200;
$config['sess_expire_on_close']    = false;
$config['sess_encrypt_cookie']    = false;
$config['sess_use_database']    = true;
$config['sess_table_name']        = DB_PREFIX.'sessions_api';
...
$config['csrf_filter'] = array('validate','uploader','login','product','travelorders','platform','paynotify');
