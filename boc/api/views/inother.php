...
if(strpos($_SERVER['HTTP_USER_AGENT'], 'iPhone')||strpos($_SERVER['HTTP_USER_AGENT'], 'iPad')){
   redirect("http://a.app.qq.com/o/simple.jsp?pkgname=com.bocweb.fly.jiaodao"); 
}else if(strpos($_SERVER['HTTP_USER_AGENT'], 'Android')){
   redirect("http://android.myapp.com/myapp/detail.htm?apkName=com.bocweb.fly.jiaodao");
}else{
    echo 'systerm is other';
}
die;

$CI->load->model('platform_model','mplatform');
 $info1=$CI->mplatform->get_one(1);
  $info2=$CI->mplatform->get_one(2);
 ?>
...
$(function(){
  var iosurl="<?php echo $info1['url']; ?>";
    var azurl="<?php echo $info2['url']; ?>";
