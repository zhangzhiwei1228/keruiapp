<div class="btn-group">
	<a href="<?php echo site_urlg('resource/index')?>" class='btn btn-primary'> <i class="fa fa-arrow-left"></i> 返回需求 </a>
	<a href="<?php echo site_urlg('resource_comment/index?did='.$did)?>" class='btn btn-primary'> <i class="fa fa-arrow-left"></i> 返回评论 </a>
</div>
