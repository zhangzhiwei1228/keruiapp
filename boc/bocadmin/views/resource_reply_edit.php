...
<div class="btn-group"><a href="<?php echo site_urlg('resource_reply/index');?>" class="btn"> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?> </a></div>
...
<div class="boxed">
	...
	<div class="boxed-inner seamless">
		...
		<div class="control-group">
			<label for="title" class="control-label">	回复用户:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label for="title" class="control-label">回复时间:</label>
			<div class="controls">
