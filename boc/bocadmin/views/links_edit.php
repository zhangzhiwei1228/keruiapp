...
<div class="boxed">
	...
	<?php echo form_open(current_urlc(),array("class"=>"form-horizontal","id"=>"frm-edit")); ?>
		...
		<div class="boxed-inner seamless">
			...
			<div class="control-group">
				<label class="control-label" for="intro">分享简介</label>
				<div class="controls">
					<textarea name="intro" rows="8" class="input-xxlarge"><?php echo set_value('intro',$it['intro']) ?></textarea>
				</div>
			</div>
...
require(['tools','adminer/js/media'],function(tools,media){
	...
	tools.make_validate('frm-edit',rules);
