...
<div class="btn-group">
	<a href="<?php echo site_url('demand/index')?>" class='btn'> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?></a>
</div>
...
<script type="text/javascript">
	...
	// media 上传
	media.init();
	var demands_photos = <?php echo json_encode(one_upload(set_value("photo"))) ?>;
