<div class="btn-group">
    <a href="<?php echo site_urlc('videosclass/create')?>" class='btn btn-primary'> <i class="fa fa-plus"></i> <?php echo $title; ?> </a>
</div>
...
require(['adminer/js/ui'],function(ui){
  var videosclass = {
    url_del: "<?php echo site_urlc('videosclass/delete'); ?>"
    ,url_audit: "<?php echo site_urlc('videosclass/audit'); ?>"
    ,url_flag: "<?php echo site_urlc('videosclass/flag'); ?>"
    ,url_sortid: "<?php echo site_urlc('videosclass/sortid'); ?>"
  };

  ui.fancybox_img();
  ui.btn_delete(videosclass.url_del);     // 删除
  ui.btn_audit(videosclass.url_audit);    // 审核
  ui.btn_flag(videosclass.url_flag);      // 推荐
  ui.sortable(videosclass.url_sortid);    // 排序
});
</script>
