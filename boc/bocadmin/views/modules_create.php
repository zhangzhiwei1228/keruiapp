...
<div class="boxed">
	<h3> <i class="fa fa-plus"></i> <?php echo $title; ?> 注册 </h3>
	<?php echo form_open(current_url(),array("class"=>"form-horizontal","id"=>"frm-create")); ?>
		...
		<div class="boxed-inner seamless">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="title" name="title" value="<?php echo set_value('title') ?>" placeholder="栏目名称" required>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="controller" name="controller" value="<?php echo set_value('controller') ?>" placeholder="Module name" required>
