...
<div class="boxed">
	...
	<div class="boxed-inner seamless">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select id="ctype"  name="ctype" class='ctype' class="bselect" data-size="auto" data-live-search="true"></select>
				<select id="link"  name="link" class='link' class="bselect" data-size="auto" data-live-search="true"></select>
			</div>
		</div>
			...
			<div class="controls">
				<div class="btn-group">
					<span class="btn btn-success">
						...
						<span> <?php echo lang('upload_file') ?> </span>[1920*750]
...
require(['adminer/js/ui','adminer/js/media','tools','bootstrap-datetimepicker.zh'],function(ui,media,tools) {
	tools.selectLink.init({
		eles:['ctype','link'],
		type:"content_banner",
		defaultValues:[<?php echo (isset($it['ctype']) && is_numeric($it['ctype']))?$it['ctype']:'' ?>, <?php echo (isset($it['link']) && is_numeric($it['link']))?$it['link']:'' ?>, 1368],
		url: '<?php echo site_url("/banners/link_select?c=12") ?>'
	});
