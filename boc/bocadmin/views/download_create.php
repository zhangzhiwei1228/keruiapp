...
<div class="btn-group">
    <a href="<?php echo site_urlc('download/index')?>" class='btn'> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?></a>
</div>
...
<div class="boxed">
    ...
    <div class="boxed-inner seamless">
        <div class="control-group">
            ...
            <div class="controls">
            <input type="text" id="title" name="title" value="<?php echo set_value("title") ?>" class='span7'>
...
<script type="text/javascript">
    ...
    // media 上传
    media.init();
    var filess_photos = <?php echo json_encode(one_upload(set_value("photo"))) ?>;
    media.show(filess_photos,"photo");

    var files_s = <?php echo json_encode(one_upload(set_value("files"))) ?>;
