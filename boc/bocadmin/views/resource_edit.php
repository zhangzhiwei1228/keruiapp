...
<div class="btn-group"><a href="<?php echo site_url('resource/index');?>" class="btn"> <i class="fa fa-arrow-left"></i> <?php echo lang('back_list')?> </a></div>
...
<script type="text/javascript">
	require(['adminer/js/ui','adminer/js/media','bootstrap-datetimepicker.zh'],function(ui,media){
		...
		media.init();
		var resources_photos = <?php echo json_encode(one_upload($it['photo'])) ?>;
