<?php if (false): ?>
<div class="btn-group">
	<a href="<?php echo site_urlg('demand/create')?>" class='btn btn-primary'> <i class="fa fa-plus"></i> <?php echo $title; ?> </a>
</div>
<?php endif; ?>
...
<table class="table table-striped table-hover select-list">
	...
	<tbody class="sort-list">
		...
		<tr data-id="<?php echo $v['id'] ?>" data-sort="<?php echo $v['sort_id'] ?>">
		  ...
		  <td> <?php echo $v['click'].' / '.$v['recommend_count'].' / ' ?> <a href="<?php echo site_urlg('demand_comment/index', array(), array('did'=>$v['id'])); ?>"><?php echo $v['comment_count']; ?></a></td>
