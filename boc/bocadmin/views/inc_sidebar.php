...
<ul class="nav nav-list nav-sidebar">
  ...
  <li class="nav-header">
      <i class="fa fa-globe" title="数据管理"></i> <span class="i-title">数据管理</span>
  </li>

  <li id='menu-account'>
    <a href="<?php echo site_url('account') ?>">
      <i class="fa fa-comments-o" title="<?php echo lang('account') ?>"></i>
      <span class="i-title"> <?php echo lang('account') ?> </span>
      <div class="wp-menu-arrow"><div></div></div>
    </a>
  </li>
  <li id='menu-circle'>
    <a href="<?php echo site_url('circle') ?>">
      <i class="fa fa-comments-o" title="商圈"></i>
      <span class="i-title"> 商圈 </span>
      <div class="wp-menu-arrow"><div></div></div>
    </a>
  </li>

  <li id='menu-demand'>
    <a href="<?php echo site_url('demand') ?>">
      <i class="fa fa-comments-o" title="<?php echo lang('demand') ?>"></i>
      <span class="i-title"> <?php echo lang('demand') ?> </span>
      <div class="wp-menu-arrow"><div></div></div>
    </a>
  </li>

  <li id='menu-resource'>
    <a href="<?php echo site_url('resource') ?>">
      <i class="fa fa-comments-o" title="<?php echo lang('resource') ?>"></i>
      <span class="i-title"> <?php echo lang('resource') ?> </span>
      <div class="wp-menu-arrow"><div></div></div>
    </a>
  </li>
