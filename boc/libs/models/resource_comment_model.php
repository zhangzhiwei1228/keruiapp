...
class resource_comment_model extends MYSOFT_Model {
	protected $table = 'resource_comment';
	...
	public function get_list_join_dcp($limit = 5, $start = 0, $order = false, $where = false, $fields = "*", $praise_aid=0)
	{
			...
			$this->db
					->select($fields)
					->from($table.' as dc')
					->join('resource_comment_praise as dcp','dcp.dcid=dc.id and dcp.aid='.$praise_aid,'left');
